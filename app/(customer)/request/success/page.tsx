...
export default function RequestSuccessPage() {
  ...
  const ConfettiParticleWrapper = mounted && MotionComponents ? MotionComponents.MotionDiv : "div";
  const CardWrapper = mounted && MotionComponents ? MotionComponents.MotionDiv : "div";
  const IconWrapper = mounted && MotionComponents ? MotionComponents.MotionDiv : "div";
  const SparklesWrapper = mounted && MotionComponents ? MotionComponents.MotionDiv : "div";
  const TitleWrapper = mounted && MotionComponents ? MotionComponents.MotionH1 : "h1";
  const DescriptionWrapper = mounted && MotionComponents ? MotionComponents.MotionP : "p";
  const BadgesWrapper = mounted && MotionComponents ? MotionComponents.MotionDiv : "div";
  const ButtonsWrapper = mounted && MotionComponents ? MotionComponents.MotionDiv : "div";
