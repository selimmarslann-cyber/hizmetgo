...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
    ...
    subServices: [
      ...
      },
      {
        ...
        keywords: [
          ...
          "işyeri inşaatı işi",
          "ticari inşaat lazım",
          "işyeri inşaatı lazım",
        ],
      },
      {
        id: "renovation-construction",
        name: "Tadilat ve renovasyon",
        keywords: [
          "tadilat",
          "renovasyon",
          "restorasyon",
      ...
      },
      {
        ...
        name: "Diğer (inşaat ile ilgili, listede yok)",
        isOther: true,
        keywords: [
          "inşaat",
          "inşaatçı",
  ...
  {
    id: "construction-exchange",
    name: "Kat Karşılığı İnşaat",
    keywords: [
      "kat karşılığı",
      "kat karşılığı inşaat",
      "kat karşılığı inşaatçı",
      "kat karşılığı müteahhit",
      "kat karşılığı yapı",
      "arazi karşılığı inşaat",
      "arazi karşılığı yapı",
      "kat karşılığı ev",
      "kat karşılığı villa",
      "kat karşılığı apartman",
      "kat karşılığı proje",
      "kat karşılığı anlaşma",
      "kat karşılığı işi",
      "kat karşılığı inşaat işi",
      "kat karşılığı lazım",
      "kat karşılığı inşaat lazım",
      "kat karşılığı müteahhit lazım",
    ],
    subServices: [
      {
        id: "residential-exchange",
        name: "Konut kat karşılığı inşaat",
        keywords: [
          "kat karşılığı ev",
          "kat karşılığı villa",
          "kat karşılığı apartman",
          "kat karşılığı konut",
          "arazi karşılığı ev",
          "arazi karşılığı villa",
          "kat karşılığı konut inşaatı",
          "kat karşılığı ev inşaatı",
          "kat karşılığı villa inşaatı",
          "kat karşılığı konut işi",
          "kat karşılığı ev işi",
          "kat karşılığı konut lazım",
          "kat karşılığı ev lazım",
        ],
      },
      {
        id: "commercial-exchange",
        name: "Ticari kat karşılığı inşaat",
        keywords: [
          "kat karşılığı işyeri",
          "kat karşılığı ofis",
          "kat karşılığı mağaza",
          "arazi karşılığı işyeri",
          "kat karşılığı ticari bina",
          "kat karşılığı ticari inşaat",
          "kat karşılığı işyeri işi",
          "kat karşılığı ticari işi",
          "kat karşılığı işyeri lazım",
          "kat karşılığı ticari lazım",
        ],
      },
      {
        id: "exchange-consulting",
        name: "Kat karşılığı danışmanlık",
        keywords: [
          "kat karşılığı danışmanlık",
          "kat karşılığı danışman",
          "kat karşılığı proje danışmanlığı",
          "kat karşılığı anlaşma danışmanlığı",
          "kat karşılığı hukuki danışmanlık",
          "kat karşılığı danışmanlık işi",
          "kat karşılığı danışmanlık lazım",
        ],
      },
      {
        id: "other-exchange",
        name: "Diğer (kat karşılığı inşaat ile ilgili, listede yok)",
        isOther: true,
        keywords: [
          "kat karşılığı",
          "kat karşılığı inşaat",
...

  {
    ...
    keywords: [
      ...
      "kentsel dönüşüm müteahhidi",
      "kentsel dönüşüm firması",
      "kentsel dönüşüm danışmanlığı",
      "kentsel dönüşüm uzmanı",
      "kentsel dönüşüm hukuki danışmanlık",
      "kentsel dönüşüm proje yönetimi",
      "kentsel dönüşüm inşaat",
      "kentsel dönüşüm yıkım",
      "kentsel dönüşüm yapı",
      "kentsel dönüşüm anlaşma",
      "kentsel dönüşüm süreci",
      "kentsel dönüşüm işi",
      "kentsel dönüşüm projesi işi",
      "kentsel dönüşüm lazım",
      "kentsel dönüşüm danışmanlığı lazım",
      "kentsel dönüşüm müteahhit lazım",
    ],
    subServices: [
      {
        id: "urban-transformation-consulting",
        name: "Kentsel dönüşüm danışmanlığı",
        keywords: [
          "kentsel dönüşüm danışmanlığı",
          "kentsel dönüşüm danışman",
          "kentsel dönüşüm uzmanı",
          "kentsel dönüşüm hukuki danışmanlık",
          "kentsel dönüşüm süreç danışmanlığı",
          "kentsel dönüşüm danışmanlığı işi",
          "kentsel dönüşüm danışmanlığı lazım",
        ],
      },
      {
        id: "urban-transformation-construction",
        name: "Kentsel dönüşüm inşaat",
        keywords: [
          "kentsel dönüşüm inşaat",
          "kentsel dönüşüm yapı",
          "kentsel dönüşüm müteahhit",
          "kentsel dönüşüm inşaat firması",
          "kentsel dönüşüm proje yönetimi",
          "kentsel dönüşüm inşaat işi",
          "kentsel dönüşüm yapı işi",
          "kentsel dönüşüm inşaat lazım",
          "kentsel dönüşüm müteahhit lazım",
        ],
      },
      {
        id: "urban-transformation-demolition",
        name: "Kentsel dönüşüm yıkım",
        keywords: [
          "kentsel dönüşüm yıkım",
          "kentsel dönüşüm yıkım işi",
          "kentsel dönüşüm yıkım lazım",
        ],
      },
      {
        id: "other-urban-transformation",
        name: "Diğer (kentsel dönüşüm ile ilgili, listede yok)",
        isOther: true,
        keywords: [
          "kentsel dönüşüm",
          "kentsel dönüşüm projesi",
    ...
    subServices: [
      ...
      },
      {
        ...
        keywords: [
          ...
          "akort",
          "müzik aleti tamiri işi",
          "enstrüman tamiri işi",
          "müzik aleti tamiri lazım",
          "enstrüman tamiri lazım",
        ],
      },
      {
        id: "other-music",
        name: "Diğer (müzik ile ilgili, listede yok)",
        isOther: true,
        keywords: [
          "müzik",
          "müzisyen",
...

  {
    ...
    subServices: [
      ...
      {
        id: "other-theater",
        name: "Diğer (tiyatro ile ilgili, listede yok)",
        isOther: true,
        keywords: [
          "tiyatro",
          "tiyatrocu",
    ...
    subServices: [
      ...
      },
      {
        ...
        keywords: [
          ...
          "sanat eğitimi işi",
          "sanat dersi lazım",
          "sanat öğretmeni lazım",
        ],
      },
      {
        id: "other-visual-arts",
        name: "Diğer (görsel sanatlar ile ilgili, listede yok)",
        isOther: true,
        keywords: [
          "ressam",
          "heykeltraş",
  ...
  // Toplam 363 kategori (6 yeni kategori eklendi: İnşaat, Kat Karşılığı İnşaat, Kentsel Dönüşüm, Müzik, Tiyatro, Görsel Sanatlar)
  // Gayrimenkul kategorisi genişletildi
