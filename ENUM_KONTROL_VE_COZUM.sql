-- ============================================
-- ADIM 1: ENUM'LARI KONTROL ET
-- ============================================
-- Bu SQL'i çalıştırın ve sonuçları kontrol edin
...
-- Eğer sonuç boşsa veya schema_name 'public' değilse, enum'ları tekrar oluşturun:

-- ============================================
-- ADIM 2: ENUM'LARI OLUŞTUR (Eğer yoksa)
-- ============================================
-- NOT: Bu SQL'i sadece enum'lar yoksa çalıştırın

-- Önce varsa sil (dikkatli!)
...
-- ============================================
-- ADIM 4: TABLOLARI OLUŞTUR
-- ============================================
-- ÖNEMLİ: Enum'ları public. prefix'i ile kullanıyoruz
...
-- ÖNEMLİ: public.ledger_entry_type kullanıyoruz
...
-- ÖNEMLİ: public.wallet_transaction_type kullanıyoruz
