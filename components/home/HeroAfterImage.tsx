  ...
  return (
    <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-12">
      <div className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-2xl">
        ...
        <div className="absolute top-0 left-0 right-0 h-16 md:h-24 lg:h-32 overflow-hidden pointer-events-none z-10">
          <svg
        ...
        <div className="absolute bottom-0 left-0 right-0 h-16 md:h-24 lg:h-32 overflow-hidden pointer-events-none z-10">
          <svg
            className="w-full h-full"
            viewBox="0 0 1440 120"
            preserveAspectRatio="none"
